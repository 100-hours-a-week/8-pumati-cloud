# root/main.tf (예시: L4 스팟 인스턴스 Taiwan)
...
module "l4_mig" {
  ...
  # 가용 영역 설정 - 대만 리전의 a, b 영역 사용 (고가용성 확보)
  ...
  # 추가 메타데이터 설정
  additional_metadata = {
    "install-nvidia-driver" = "True" # 딥러닝 VM에서 GPU 드라이버 자동 설치 활성화
  }
