...
project_id   = "loyal-parser-463101-n8"  # 실제 GCP 프로젝트 ID로 변경 필요

# 환경 설정
environment  = "prod-vicky"  # dev, staging, prod 중 선택
...
common_tags = ["terraform", "ktb8team", "prod-vicky", "jacky"]

# 공통 라벨 설정 (키-값 맵 유지)
common_labels = {
  "managed-by"  = "terraform"
  "project"     = "ktb8team"
  "environment" = "prod-vicky"
  "owner"       = "jacky"
}

# 도메인 관련 설정
domain_name  = "prod-vicky.mydairy.my"  # 서비스 도메인
