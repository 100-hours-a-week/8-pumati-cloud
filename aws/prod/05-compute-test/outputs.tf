...
output "frontend_private_ip" {
  ...
  value       = module.frontend_instance_test.private_ip
}
...
output "backend_private_ip" {
  ...
  value       = module.backend_instance_test.private_ip
}

# DB 인스턴스 출력
output "db_instance_id" {
  description = "DB 인스턴스 ID"
  value       = module.db_instance_test.instance_id
}

output "db_private_ip" {
  description = "DB 인스턴스의 프라이빗 IP"
  value       = module.db_instance_test.private_ip
}
