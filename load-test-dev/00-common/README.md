...
| <a name="input_environment"></a> [environment](#input\_environment) | 환경 (dev, staging, prod, test, shared, load-test) | `string` | n/a | yes |
...
| <a name="output_environment"></a> [environment](#output\_environment) | 환경 (dev, staging, prod, test, shared, load-test) |
